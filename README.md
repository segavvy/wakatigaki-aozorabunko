...
なお、青空文庫で公開されている作品の利用に当たっては、作品本文以外の記載事項を削除しないことが望ましいのですが、テキストファイルに含めてしまうと利用しにくくなるため、ファイルには含めず以下に記載しています。
...
2020年5月16日時点の13の公開ファイル（「吾輩は猫である」〜「宇宙怪人」）を1ファイルにマージしたものも公開します。約4.7MBです。

## 20201207merge.txt

2020年12月7日に追加した3ファイル（「明暗」〜「人間椅子」）を1ファイルにマージしたものです。約1.3MBです。

## 20201231merge.txt

2020年12月31日に追加した3ファイル（「虞美人草」〜「盗難」）を1ファイルにマージしたものです。約0.9MBです。
